...
require 'java_buildpack/container/jeus/gemfire/gemfire'
require 'java_buildpack/container/jeus/gemfire/gemfire_logging_api'
require 'java_buildpack/container/jeus/gemfire/gemfire_logging'
require 'java_buildpack/container/jeus/gemfire/gemfire_modules'
require 'java_buildpack/container/jeus/gemfire/gemfire_modules_jeus7'
require 'java_buildpack/container/jeus/gemfire/gemfire_security'
require 'java_buildpack/container/jeus/jeus_utils'
...
module JavaBuildpack
  module Container
    ...
    # Encapsulates the detect, compile, and release functionality for Jeus gemfire support.
    class JeusGemfireStore < JavaBuildpack::Component::ModularComponent
      ...
      def sub_components(context)
        [
          ...
          GemFireModulesJeus7.new(sub_configuration_context(context, 'gemfire_modules_jeus7')),
      ...
      PERSISTENT_MANAGER_CLASS = 'com.gemstone.gemfire.modules.session.catalina.Jeus7DeltaSessionManager'.freeze
